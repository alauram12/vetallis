...
#usuario
INSERT INTO usuario (usuario_senha, usuario_email, usuario_nome, usuario_cpf, usuario_cargo)
VALUES ('1234', 'teste@gmail.com', 'teste', '12345678910', 'gerente');

INSERT INTO usuario (usuario_senha, usuario_email, usuario_nome, usuario_cpf, usuario_cargo)
VALUES ('5678', 'mariaeduardamartinscavallaro@gmail.com', 'Maria Eduarda Martins Cavallaro', '49089469818', 'diretora'),
...
SELECT usuario_cargo, usuario_email FROM usuario
WHERE usuario_id =2;
...
#produto
INSERT INTO produto (produto_nome, produto_quantidade, produto_descricao, produto_lote, produto_cod_barra, produto_categoria)
VALUES ('dipirona', 13,'cura dor de cabeça', '12A', '1234567890123', 'vacina'),
...
SELECT produto_lote, produto_descricao FROM produto
WHERE produto_id= 2;
...
#pedido_saida
INSERT INTO pedido_saida (pedido_saida_lote, pedido_saida_nome, pedido_saida_categoria, pedido_saida_quantidade, usuario_usuario_id1, produto_produto_id)
VALUES ('1540M','paracetamol', 'comprimido', 2, 4, 4),
...
SELECT pedido_saida_nome FROM pedido_saida
...
SELECT pedido_saida_nome, pedido_saida_quantidade FROM pedido_saida
...
#pedido_entrada
INSERT INTO pedido_entrada (pedido_ent_lote, pedido_ent_nome, pedido_ent_categoria, pedido_ent_quantidade, pedido_ent_descricao, usuario_usuario_id1, produto_produto_id)
VALUES ('1540S','dipirona', 'comprimido', 2, 'usado para dor de cabeça', 4, 4),
('2000T','losartana', 'xarope', 80, 'passar vomito',5, 5),
('13999ER','rivotril', 'vacina', 200, 'curar dor nas costas', 6, 6);
...
SELECT pedido_ent_nome FROM pedido_entrada 
WHERE usuario_usuario_id1 =6;

SELECT pedido_ent_nome, pedido_ent_quantidade FROM pedido_entrada 
WHERE usuario_usuario_id1 =6;
...
#lista_compra
INSERT INTO lista_compra (lista_compra_nome, lista_compra_quantidade, lista_compra_valor, produto_produto_id, lista_compra_status)
VALUES ('comprar dipirona',12, 50.00, 4, 'venceu'),
('comprar losartana',100, 200.50, 5, 'esgotado'),
('comprar novalgina', 30, 100, 6, 'acabando');
...
UPDATE lista_compra 
SET lista_compra_valor = 180.00
WHERE produto_produto_id= 5;

UPDATE lista_compra
SET lista_compra_status = 'vencido'
WHERE produto_produto_id= 6;

SELECT * FROM lista_compra;

SELECT lista_compra_nome FROM lista_compra
WHERE lista_compra_quantidade > 12;

SELECT lista_compra_nome, lista_compra_status FROM lista_compra
WHERE produto_produto_id =6;

DELETE FROM lista_compra
WHERE lista_compra_id =4;

DELETE FROM lista_compra
WHERE lista_compra_id  =5;

DELETE FROM lista_compra
WHERE lista_compra_id  =6;

#controle_saida
INSERT INTO controle_saida (controle_saida_motivo, controle_saida_quantidade, controle_saida_nome, controle_saida_data, pedido_saida_pedido_saida_id1)
VALUES ('curar dor de cabeça', 7, 'aspirina', '2025-09-13', 10),
('curar verme', 9, 'vermifugo', '2025-09-01', 11),
('curar vomito', 12, 'buscofem', '2025-12-03', 12);

UPDATE controle_saida
SET controle_saida_quantidade = 16
WHERE pedido_saida_pedido_saida_id1= 10;

UPDATE controle_saida 
SET controle_saida_motivo = 'dor de barriga'
WHERE pedido_saida_pedido_saida_id1= 12;

UPDATE controle_saida
SET controle_saida_nome = 'antibiótico'
WHERE pedido_saida_pedido_saida_id1= 11;

SELECT * FROM controle_saida;

SELECT controle_saida_nome FROM controle_saida
WHERE  controle_saida_quantidade > 8;

SELECT controle_saida_nome, controle_saida_motivo FROM controle_saida
WHERE pedido_saida_pedido_saida_id1 =10;

DELETE FROM controle_saida
WHERE pedido_saida_pedido_saida_id1 =10;
...
#controle_entrada
INSERT INTO controle_entrada (controle_entrada_quantidade, controle_entrada_nome, controle_entrada_descricao ,controle_entrada_data, pedido_entrada_pedido_ent_id1)
VALUES (7, 'aspirina', 'dor', '2025-09-13', 4),
(9, 'vermifugo', 'curar verme', '2025-09-01', 5),
(12, 'buscofem','curar vomito','2025-12-03', 6);
...
UPDATE controle_entrada
SET controle_entrada_descricao = 'dor de barriga'
WHERE pedido_entrada_pedido_ent_id1= 6;

UPDATE controle_entrada
SET controle_entrada_nome = 'antibiótico'
WHERE pedido_entrada_pedido_ent_id1= 5;

SELECT * FROM controle_entrada;

SELECT controle_entrada_quantidade FROM controle_entrada
WHERE  controle_entrada_nome = 'buscofem';

SELECT controle_entrada_nome, controle_entrada_descricao FROM controle_entrada
WHERE pedido_entrada_pedido_ent_id1 =6;

DELETE FROM controle_entrada
WHERE pedido_entrada_pedido_ent_id1 =4;
...
VALUES (7, '2025-09-13', 13),
(9, '2025-09-01', 14),
(12, '2025-12-03', 15);

UPDATE historico_saida
SET historico_saida_quantidade = 16
WHERE controle_saida_controle_saida_id= 14;
...
UPDATE historico_saida
SET historico_saida_data= '2025-12-06'
...
DELETE FROM historico_saida
WHERE controle_saida_controle_saida_id =15;
...
DELETE 
FROM historico_entrada
WHERE historico_entrada_id = 4;

DELETE 
FROM historico_entrada
WHERE historico_entrada_id = 5;

DELETE 
FROM historico_entrada
WHERE historico_entrada_id = 6;
